...
export default function RecommendationsCard({ recommendations, conditionMap, onViewAll }) {
  ...
  const handleViewAll = () => {
    onViewAll?.()
    /* The full section is rendered after the dashboard switches tabs. */
    window.setTimeout(() => {
      document.getElementById('full-recommendations-section')
